...
var Timetable = /** @class */ (function () {
    ...
    Timetable.prototype.assignGroupSlot = function (day, period, item, _id, groups) {
        ...
        var assignee = group.items.find(function (i) { return i._id; }).assignee;
        var theConflict = conflicts.find(function (c) { return c.assignee == assignee; });
        if (theConflict)
    ...
    Timetable.prototype.automateMultiple = function (groups, heirachy) {
        var _a;
        var data = this.clone();
        ...
        for (var i = 0; i < groups.length; i++) {
            ...
            var groupAssignees = __spreadArray([], __read(new Set(group.items.reduce(function (acc, red) { return __spreadArray(__spreadArray([], __read(acc)), [red.assignee]); }, []))));
    ...
    Timetable.prototype.canAssignToSlot = function (item, groupId, day, period, groups) {
        ...
        var assignee = group === null || group === void 0 ? void 0 : group.items.find(function (i) { return i._id == item; }).assignee;
