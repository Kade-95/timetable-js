            ...
            for (var day in slots) {
                for (var period in slots[day]) {
                    ...
                    if (this.getGroupInvalidItems(group._id, groupItems).includes(item))
                        continue;
                    if (((_a = assigned[day + "." + period]) === null || _a === void 0 ? void 0 : _a.assignee) == assignee) {
                        if (((_b = assigned[day + "." + period]) === null || _b === void 0 ? void 0 : _b.item) != item
                            || ((_c = assigned[day + "." + period]) === null || _c === void 0 ? void 0 : _c.section) != group.section) {
...
exports.TimetableManager = TimetableManager;
